  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: "/charts-and-maps/charts/high-charts",
          name: "extra-component-charts-high-charts",
          component: () =>
            import("@/views/charts-and-maps/charts/high-charts/HighCharts.vue"),
          meta: {
            breadcrumb: [
              { title: "Home", url: "/" },
              { title: "Charts & Maps" },
              { title: "High Charts", active: true },
            ],
            pageTitle: "High Charts",
            rule: "editor",
          },
        },
        {
